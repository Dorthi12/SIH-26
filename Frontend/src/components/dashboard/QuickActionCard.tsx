  ...
  return (
    <button
      ...
      className={cn(
        ...
        primary
          ? "border-forest/20 bg-forest/[0.04] hover:bg-forest/[0.07] hover:border-forest/30"
    ...
    >
      <div className={cn(
        ...
        primary
          ? "bg-forest text-white group-hover:shadow group-hover:scale-105"
          : "bg-forest/8 text-forest group-hover:bg-forest group-hover:text-white group-hover:scale-105"
      )}>
        {icon}
      </div>
      <div className="flex-1 min-w-0">
        <p className={cn(
          ...
          primary ? "text-forest" : "text-charcoal group-hover:text-forest"
        )}>{label}</p>
        <p className="text-xs text-charcoal-muted truncate">{description}</p>
      </div>
      <ArrowRight className="h-4 w-4 text-charcoal-muted/40 group-hover:text-forest group-hover:translate-x-1 transition-all shrink-0" />
    </button>
  );
}
