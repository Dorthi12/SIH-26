...
export function RecommendationHero({ cropName, rank, className, id }: RecommendationHeroProps) {
  return (
    <div id={id} className={cn("flex flex-col sm:flex-row items-start sm:items-center gap-5", className)}>
      {/* Crop icon */}
      <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-forest text-white shadow-md shadow-forest/20">
