  ...
  return (
    ...
    >
      <div className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-forest shadow-sm transition-transform duration-200 group-hover:scale-105">
        ...
        <Sparkles
          className="absolute -top-1 -right-1 h-3 w-3 text-amber"
          strokeWidth={2.5}
        />
      </div>
    ...
    >
      ...
      <Icon
        className={cn(
          ...
          isActive
            ? "text-forest"
            : "text-charcoal-muted/70 group-hover:text-charcoal"
        )}
...
const ROUTE_TITLES: Record<string, string> = {
  "/": "Home",
  "/dashboard": "Dashboard",
  "/mandi": "Mandi Marketplace",
  "/complaints": "Complaints",
  "/createcomplaints": "Create Complaint",
  "/viewcomplaints": "All Complaints",
  "/viewmycomplaints": "My Complaints",
  ...
  "/zero-production-risk": "Zero-Production Risk",
  "/about": "About",
