"""
disease_model.py — EfficientNet-B0 singleton model loader (Model 5).
...
class DiseaseModel:
    ...
    Usage:
        ...
        disease_model.predict_logits(tensor)
    ...
    def load(self) -> None:
        ...
        # Calibration (optional — safe defaults if calibration.json absent)
